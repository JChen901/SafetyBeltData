...
for i in {1..20}
do
    plumed driver --plumed plumed_$i.dat --pdb /hpc2hdd/home/jchen901/data/genesis/GENESIS_Tutorials-2022/Works/SMC_AICG2+/Kleisin_interaction_test/replica/para_0.35/w0.35-$i/run1/pro_dna_test_run.pdb --mf_dcd /hpc2hdd/home/jchen901/data/genesis/GENESIS_Tutorials-2022/Works/SMC_AICG2+/Kleisin_interaction_test/replica/para_0.35/w0.35-$i/run1/pro_dna_test_run.dcd --timestep 100
done