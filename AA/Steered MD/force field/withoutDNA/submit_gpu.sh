...
gmx mdrun -deffnm eq -nb gpu -pme gpu -bonded gpu -update gpu -gpu_id 0 -ntmpi 1 -ntomp 16
'''
#Steer MD

gmx grompp -f pull.mdp -o pull.tpr -c eq.gro -r $gro -p $top -n index.ndx -t eq.cpt -maxwarn 2
gmx mdrun -deffnm pull -nb gpu -pme gpu -bonded gpu -update gpu -gpu_id 0 -ntmpi 1 -ntomp 16
